/****************************************************************************
** Meta object code from reading C++ file 'cg.h'
**
** Created: Wed 16. Mar 00:22:04 2011
...
#error "The header file 'cg.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_GLPainter[] = {
    "GLPainter\0\0changeBrightness(float)\0"
};
...
int GLPainter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: changeBrightness((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
